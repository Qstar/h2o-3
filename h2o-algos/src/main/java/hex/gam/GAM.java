  ...
  private class GAMDriver extends Driver {
    ...
    public final void buildModel() {
      ...
      if (_parms._saveGamCols)
        model._output._gamTransformedTrain = newTFrame._key; // user needs to delete this frame to avoid leaked keys
      else
    ...
    GLMModel buildGLMModel(GAMParameters parms, Frame trainData) {
      GLMParameters glmParam = GamUtils.copyGAMParams2GLMParams(_parms, trainData);  // copy parameter from GAM to GLM
